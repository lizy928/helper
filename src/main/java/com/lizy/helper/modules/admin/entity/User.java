...
import com.lizy.helper.modules.common.validator.Create;
import com.lizy.helper.modules.common.validator.FieldRepeatValidator;
import com.lizy.helper.modules.common.validator.Update;
...
//	@FieldRepeatValidator(className = "com.lizy.helper.modules.admin.entity.User", field = "pwd", message = "密码重复！")
//	@FieldRepeatValidator(className = "com.lizy.helper.modules.admin.entity.User", field = "pwd", message = "密码重复！",groups={FieldRepeatValidator.class})
	private String pwd;
    /**
     * 昵称
     */
